...
- **[index.html](https://apartsinprojects.github.io/cxr-selective-rejection/)**: the revised manuscript. Tracked-edit highlighting versus the Round-2 version uses green for newly added content and yellow for modified content (prose, captions, and table cells). It carries 8 figures and 3 tables, evaluated on three public datasets (NIH ChestX-ray14 n=11,212, MIMIC-CXR n=8,185, PadChest n=18,000) with bootstrap confidence intervals.
